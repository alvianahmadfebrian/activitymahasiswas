...
return [
    ...
    */
    ...
    'between'              => [
        'numeric' => 'Isian :attribute harus antara :min and :max.',
        'file'    => 'Isian :attribute harus antara :min and :max kilobytes.',
        'string'  => 'Isian :attribute harus antara :min and :max karakter.',
        'array'   => 'Isian :attribute harus antara :min and :max item.',
    ],
