                ...
                <form method="POST" action="{{ route('register.post') }}" enctype="multipart/form-data">
                    ...
                    <div class="grid gap-3 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input
                                    name="name"
                                    value="{{ old('name') }}"
                                    class="w-full rounded-xl border {{ $errors->has('name') ? 'border-red-500 bg-red-50/20 focus:ring-red-100 focus:border-red-500' : 'border-slate-200/80 bg-white/85 focus:ring-blue-100 focus:border-blue-500' }} pl-10 pr-3 py-2.5 text-sm text-slate-800 outline-none transition placeholder:text-slate-400 focus:bg-white focus:ring-4"
                            ...
                            @error('name')
                                <p class="mt-1.5 flex items-center gap-1 text-xs font-semibold text-red-500">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input
                                    name="nim"
                                    value="{{ old('nim') }}"
                                    class="w-full rounded-xl border {{ $errors->has('nim') ? 'border-red-500 bg-red-50/20 focus:ring-red-100 focus:border-red-500' : 'border-slate-200/80 bg-white/85 focus:ring-blue-100 focus:border-blue-500' }} pl-10 pr-3 py-2.5 text-sm text-slate-800 outline-none transition placeholder:text-slate-400 focus:bg-white focus:ring-4"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    type="email"
                                    value="{{ old('email') }}"
                                    class="w-full rounded-xl border {{ $errors->has('email') ? 'border-red-500 bg-red-50/20 focus:ring-red-100 focus:border-red-500' : 'border-slate-200/80 bg-white/85 focus:ring-blue-100 focus:border-blue-500' }} pl-10 pr-3 py-2.5 text-sm text-slate-800 outline-none transition placeholder:text-slate-400 focus:bg-white focus:ring-4"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input
                                    name="prodi"
                                    value="{{ old('prodi') }}"
                                    class="w-full rounded-xl border {{ $errors->has('prodi') ? 'border-red-500 bg-red-50/20 focus:ring-red-100 focus:border-red-500' : 'border-slate-200/80 bg-white/85 focus:ring-blue-100 focus:border-blue-500' }} pl-10 pr-3 py-2.5 text-sm text-slate-800 outline-none transition placeholder:text-slate-400 focus:bg-white focus:ring-4"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input
                                    name="kelas"
                                    value="{{ old('kelas') }}"
                                    class="w-full rounded-xl border {{ $errors->has('kelas') ? 'border-red-500 bg-red-50/20 focus:ring-red-100 focus:border-red-500' : 'border-slate-200/80 bg-white/85 focus:ring-blue-100 focus:border-blue-500' }} pl-10 pr-3 py-2.5 text-sm text-slate-800 outline-none transition placeholder:text-slate-400 focus:bg-white focus:ring-4"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <label class="flex cursor-pointer items-center gap-3 rounded-xl border border-dashed {{ $errors->has('photo') ? 'border-red-500 bg-red-50/20 hover:border-red-600' : 'border-blue-200 bg-white/80 hover:border-blue-500 hover:bg-blue-50/70' }} px-3 py-2.5 transition">
                                <div id="photoPreview" class="flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-blue-50 text-xs font-black {{ $errors->has('photo') ? 'text-red-500' : 'text-blue-700' }}">
                                    CH
                                </div>
                                ...
                                <svg class="h-5 w-5 shrink-0 {{ $errors->has('photo') ? 'text-red-500' : 'text-blue-500' }}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <div>
                            <div class="mb-1.5 flex items-center justify-between">
                                ...
                                <span class="text-[10px] font-bold {{ $errors->has('password') ? 'text-red-500 bg-red-50 border border-red-100 px-1.5 py-0.5 rounded-md' : 'text-slate-400 bg-slate-100 border border-slate-200/50 px-1.5 py-0.5 rounded-md' }}">Min. 6 karakter</span>
                            </div>
                            <div class="relative">
                                <svg class="pointer-events-none absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                ...
                                <input
                                    ...
                                    type="password"
                                    id="password"
                                    class="w-full rounded-xl border {{ $errors->has('password') ? 'border-red-500 bg-red-50/20 focus:ring-red-100 focus:border-red-500' : 'border-slate-200/80 bg-white/85 focus:ring-blue-100 focus:border-blue-500' }} pl-10 pr-10 py-2.5 text-sm text-slate-800 outline-none transition placeholder:text-slate-400 focus:bg-white focus:ring-4"
