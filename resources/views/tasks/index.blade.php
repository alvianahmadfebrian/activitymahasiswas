...
function openModal(url, type, name) {
    ...
    // Deteksi apakah URL mengarah ke localhost/local domain
    let isLocal = false;
    try {
    ...
    if (type === "image") {
        ...
        // Untuk PDF, kita langsung memuat URL secara native (built-in viewer browser)
        // Ini bekerja di localhost maupun produksi tanpa penolakan koneksi dari Google Docs Viewer
        iframe.src = url;
        ...
        if (isLocal) {
            ...
            <div class="tp-modal-nopreview">
                <svg viewBox="0 0 24 24" fill="none" style="width:40px;height:40px;margin:0 auto 12px;display:block;color:#f59e0b">
                    <path d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"
                        stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                <p>
                    Pratinjau dokumen Office (Word/Excel/PowerPoint) tidak tersedia di lingkungan lokal (localhost).
                    <br><br>
                    Silakan klik tombol <strong>Download</strong> atau <strong>Buka tab baru</strong> di atas untuk membaca dokumen ini.
                </p>
            </div>
            `;
        } else {
